...
lib_src = $(wildcard $(SRC_DIR)/sdc*.cpp)
lib_obj := $(patsubst %.cpp, %.o, $(lib_src))
lib_obj := $(foreach obj, $(lib_obj), $(patsubst $(SRC_DIR)/%.o, $(OBJ_DIR)/%.o, $(obj)))

LEXER_SRC = $(SRC_DIR)/sdc_lexer.l
LEXER_GEN_SRC = $(SRC_DIR)/sdc_lexer.gen.c
LEXER_GEN_HDR = $(SRC_DIR)/sdc_lexer.gen.h
LEXER_GEN_OBJ := $(LEXER_GEN_SRC:.c=.o)
LEXER_GEN_OBJ := $(foreach obj, $(LEXER_GEN_OBJ), $(patsubst $(SRC_DIR)/%.o, $(OBJ_DIR)/%.o, $(obj)))

PARSER_SRC = $(SRC_DIR)/sdc_parser.y
PARSER_GEN_SRC = $(SRC_DIR)/sdc_parser.gen.c
PARSER_GEN_HDR = $(SRC_DIR)/sdc_parser.gen.h
