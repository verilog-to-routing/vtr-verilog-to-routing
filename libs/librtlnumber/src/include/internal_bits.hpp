...
static const bit_value_t l_and[4][4] = {
    ...
    /* x */ {_0, _x, _x, _x},
    /* z */ {_0, _x, _x, _x}};
static const bit_value_t l_nand[4][4] = unroll_2d_invert(l_and);
...
static const bit_value_t l_or[4][4] = {
    ...
    /* x */ {_x, _1, _x, _x},
    /* z */ {_x, _1, _x, _x}};
static const bit_value_t l_nor[4][4] = unroll_2d_invert(l_or);
...
static const bit_value_t l_xor[4][4] = {
    ...
    /* x */ {_x, _x, _x, _x},
    /* z */ {_x, _x, _x, _x}};
static const bit_value_t l_xnor[4][4] = unroll_2d_invert(l_xor);
...
static const bit_value_t l_case_neq[4][4] = unroll_2d_invert(l_case_eq);
...
static const bit_value_t l_eq[4][4] = unroll_2d(l_xnor);
...
class BitFields {
  ...
  public:
    BitFields(bit_value_t init_v) {
        this->bits = (_0 == init_v) ? _All_0 : (_1 == init_v) ? _All_1 : (_z == init_v) ? _All_z : _All_x;
    }
