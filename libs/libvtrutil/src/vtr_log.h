 ...
 *     - VTR_LOG_ERROR   : An error log message. This represents a clear issue that should result in stopping the program execution. Pease note that using this log message will not actually terminate the program
 * 
 * For example:
 *
