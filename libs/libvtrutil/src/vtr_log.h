...
/**
 * @file
 * @brief This header defines useful logging macros for VTR projects. The VPR API should be used to identify VPR execution errors and these can be found in [VPR Errors](../vpr/errors.html).
 *
 * Message Type
 * ============
 *
