...
static void ProcessSwitches(pugi::xml_node Parent,
	...
	*Switches = nullptr;
	...
	for (i = 0; i < *NumSwitches; ++i) {
        ...
        ReqOpt CINTERNAL_REQD = OPTIONAL; // declare a parameter for C_internal 
        ...
        arch_switch.Cinternal = get_attribute(Node, "Cinternal", loc_data, CINTERNAL_REQD).as_float(0); // retrieve the value of Cinternal, otherwise set to zero.
