...
int get_sb_formula_raw_result(FormulaParser& formula_parser,
    ...
    if (formula_parser.is_piecewise_formula(formula.c_str())) {
        // EXPERIMENTAL
        result = formula_parser.parse_piecewise_formula(formula.c_str(), mydata);
    } else {
