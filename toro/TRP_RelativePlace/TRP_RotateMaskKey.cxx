//===========================================================================//
// Purpose : Method definitions for the TRP_RotateMaskKey class.
//
//           Public methods include:
//           - TRP_RotateMaskKey_c, ~TRP_RotateMaskKey_c
//           - operator=, operator<
//           - operator==, operator!=
//           - Print
//
...
//===========================================================================//
TRP_RotateMaskKey_c::TRP_RotateMaskKey_c( 
      const TRP_RotateMaskKey_c& rotateMaskKey )
      :
...
// 01/15/13 jeffr : Original
//===========================================================================//
TRP_RotateMaskKey_c& TRP_RotateMaskKey_c::operator=( 
      const TRP_RotateMaskKey_c& rotateMaskKey )
{
...
// 01/15/13 jeffr : Original
//===========================================================================//
bool TRP_RotateMaskKey_c::operator<( 
      const TRP_RotateMaskKey_c& rotateMaskKey ) const
{
   bool lessThan = false;
...
// 01/15/13 jeffr : Original
//===========================================================================//
void TRP_RotateMaskKey_c::Print( 
      FILE*  pfile,
