//===========================================================================//
// Purpose : Method definitions for the TRP_RelativeNode class.
//
//           Public methods include:
//           - TRP_RelativeNode_c, ~TRP_RelativeNode_c
//           - operator=
//           - operator==, operator!=
//           - Print
//           - SetSideIndex
...
//===========================================================================//
TRP_RelativeNode_c::TRP_RelativeNode_c( 
      const TRP_RelativeNode_c& relativeNode )
      :
...
// 01/15/13 jeffr : Original
//===========================================================================//
TRP_RelativeNode_c& TRP_RelativeNode_c::operator=( 
      const TRP_RelativeNode_c& relativeNode )
{
...
// 01/15/13 jeffr : Original
//===========================================================================//
bool TRP_RelativeNode_c::operator==( 
      ...
      size_t spaceLen ) const
{
   ...
   if(( this->sideIndex_.left != TRP_RELATIVE_NODE_UNDEFINED ) ||
      ( this->sideIndex_.right != TRP_RELATIVE_NODE_UNDEFINED ) ||
      ( this->sideIndex_.lower != TRP_RELATIVE_NODE_UNDEFINED ) ||
      ( this->sideIndex_.upper != TRP_RELATIVE_NODE_UNDEFINED ))
   {
      ...
      if( this->sideIndex_.right != TRP_RELATIVE_NODE_UNDEFINED )
      ...
      if( this->sideIndex_.lower != TRP_RELATIVE_NODE_UNDEFINED )
      ...
      if( this->sideIndex_.upper != TRP_RELATIVE_NODE_UNDEFINED )
...
// 01/15/13 jeffr : Original
//===========================================================================//
void TRP_RelativeNode_c::SetSideIndex(
      TC_SideMode_t side,
...
// 01/15/13 jeffr : Original
//===========================================================================//
size_t TRP_RelativeNode_c::GetSideIndex(
...
// 01/15/13 jeffr : Original
//===========================================================================//
bool TRP_RelativeNode_c::HasSideIndex(
      TC_SideMode_t side ) const
{
   ...
   {
   case TC_SIDE_LEFT: 
      hasSideIndex = ( this->sideIndex_.left != TRP_RELATIVE_NODE_UNDEFINED ? 
                       true : false );
      break;
   case TC_SIDE_RIGHT: 
      hasSideIndex = ( this->sideIndex_.right != TRP_RELATIVE_NODE_UNDEFINED ? 
                       true : false );
      break;
   case TC_SIDE_LOWER: 
      hasSideIndex = ( this->sideIndex_.lower != TRP_RELATIVE_NODE_UNDEFINED ? 
                       true : false );
      break;
   case TC_SIDE_UPPER: 
      hasSideIndex = ( this->sideIndex_.upper != TRP_RELATIVE_NODE_UNDEFINED ? 
                       true : false );
      break;
   default:
      break;
...
// 01/15/13 jeffr : Original
//===========================================================================//
void TRP_RelativeNode_c::Reset( 
      void )
{
   this->vpr_gridPoint_.Reset( );

   this->sideIndex_.left = TRP_RELATIVE_NODE_UNDEFINED;
   this->sideIndex_.right = TRP_RELATIVE_NODE_UNDEFINED;
   this->sideIndex_.lower = TRP_RELATIVE_NODE_UNDEFINED;
   this->sideIndex_.upper = TRP_RELATIVE_NODE_UNDEFINED;
} 
