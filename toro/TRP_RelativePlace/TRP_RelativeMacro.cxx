...
TRP_RelativeMacro_c::TRP_RelativeMacro_c( 
      void )
      :
      relativeNodeList_( TRP_RELATIVE_NODE_LIST_DEF_CAPACITY )
{
} 
...
// 01/15/13 jeffr : Original
//===========================================================================//
TRP_RelativeMacro_c& TRP_RelativeMacro_c::operator=( 
      const TRP_RelativeMacro_c& relativeMacro )
{
...
// 01/15/13 jeffr : Original
//===========================================================================//
bool TRP_RelativeMacro_c::operator==( 
...
// 01/15/13 jeffr : Original
//===========================================================================//
TRP_RelativeNode_c* TRP_RelativeMacro_c::operator[]( 
...
// 01/15/13 jeffr : Original
//===========================================================================//
void TRP_RelativeMacro_c::Print( 
      FILE*  pfile,
      size_t spaceLen ) const
{
   ...
   {
      TRP_RelativeNode_c* prelativeNode = this->relativeNodeList_[i];
...
// 01/15/13 jeffr : Original
//===========================================================================//
TRP_RelativeNode_c* TRP_RelativeMacro_c::Find( 
      size_t relativeNodeIndex ) const
{
            ...
            TGO_RotateMode_t rotate )
{
   ...
   TRP_RelativeNode_c* prelativeNode = this->Find( relativeNodeIndex );
   if( prelativeNode )
   {
...
{
   // Start by setting given relative node based on the given origin point
   TRP_RelativeNode_c* prelativeNode = Find( relativeNodeIndex );
   if( prelativeNode &&
...
// 01/15/13 jeffr : Original
//===========================================================================//
void TRP_RelativeMacro_c::Clear( 
      void ) 
{
...
// 01/15/13 jeffr : Original
//===========================================================================//
void TRP_RelativeMacro_c::Reset(
      void )
{
   for( size_t i = 0; i < this->relativeNodeList_.GetLength( ); ++i )
   {
...
// 01/15/13 jeffr : Original
//===========================================================================//
void TRP_RelativeMacro_c::LinkNodes_(
      size_t        fromNodeIndex,
      size_t        toNodeIndex,
      TC_SideMode_t side ) const
{
   // Find nodes based on given node indices
   TRP_RelativeNode_c* pfromNode = this->relativeNodeList_[fromNodeIndex];
   TRP_RelativeNode_c* ptoNode = this->relativeNodeList_[toNodeIndex];
