...
if ( $ending_stage >= $stage_idx_vpr and !$error_code ) {
    ...
    if (!$route_fixed_W) {
		...
		# Timing files generated by the VPR analysis stage
		...
		my $pack_pin_file = "packing_pin_util.rpt";
		my $pre_pack_setup_time_report = "pre_pack.report_timing.setup.rpt";
		my $rename_result;
		...
		my $full_pack_pin_file = "full_packing_pin_util.rpt";
		my $full_pre_pack_setup_time_report = "full_pre_pack.report_timing.setup.rpt";
		...
		# rename all the timing files generated by full STA
		$rename_result = &system_with_timeout(
    			$move_exec, "",
        		$timeout, $temp_dir,
        		$setup_time_report, $full_setup_time_report
			);

		$rename_result = &system_with_timeout(
    			$move_exec, "move.out",
        		$timeout, $temp_dir,
        		$hold_time_report, $full_hold_time_report
			);

		$rename_result = &system_with_timeout(
    			$move_exec, "move.out",
        		$timeout, $temp_dir,
        		$unconstrained_setup_time_report, $full_unconstrained_setup_time_report
			);

		$rename_result = &system_with_timeout(
    			$move_exec, "move.out",
        		$timeout, $temp_dir,
        		$unconstrained_hold_time_report, $full_unconstrained_hold_time_report
			);

		$rename_result = &system_with_timeout(
    			$move_exec, "move.out",
        		$timeout, $temp_dir,
        		$pack_pin_file, $full_pack_pin_file
			);

		$rename_result = &system_with_timeout(
    			$move_exec, "move.out",
        		$timeout, $temp_dir,
        		$pre_pack_setup_time_report, $full_pre_pack_setup_time_report
			);
		...
		my $incr_pack_pin_file = "incr_packing_pin_util.rpt";
		my $incr_pre_pack_setup_time_report = "incr_pre_pack.report_timing.setup.rpt";
		...
		# rename all the timing files generated by incremental STA
		$rename_result = &system_with_timeout(
    			$move_exec, "",
        		$timeout, $temp_dir,
        		$setup_time_report, $incr_setup_time_report
			);

		$rename_result = &system_with_timeout(
    			$move_exec, "move.out",
        		$timeout, $temp_dir,
        		$hold_time_report, $incr_hold_time_report
			);

		$rename_result = &system_with_timeout(
    			$move_exec, "move.out",
        		$timeout, $temp_dir,
        		$unconstrained_setup_time_report, $incr_unconstrained_setup_time_report
			);

		$rename_result = &system_with_timeout(
    			$move_exec, "move.out",
        		$timeout, $temp_dir,
        		$unconstrained_hold_time_report, $incr_unconstrained_hold_time_report
			);

		$rename_result = &system_with_timeout(
    			$move_exec, "move.out",
        		$timeout, $temp_dir,
        		$pack_pin_file, $incr_pack_pin_file
			);

		$rename_result = &system_with_timeout(
    			$move_exec, "move.out",
        		$timeout, $temp_dir,
        		$pre_pack_setup_time_report, $incr_pre_pack_setup_time_report
			);
		...
		my $diff_pack_pin_file = &system_with_timeout(
    			$diff_exec, "diff.out",
        		$timeout, $temp_dir,
        		$full_pack_pin_file, $incr_pack_pin_file
			);

		my $diff_pre_pack_setup_time_report = &system_with_timeout(
    			$diff_exec, "diff.out",
        		$timeout, $temp_dir,
        		$full_pre_pack_setup_time_report, $incr_pre_pack_setup_time_report
			);
		...
		if (($diff_setup_time_report ne "success") or ($diff_hold_time_report ne "success") or 
			...
			($diff_pack_pin_file ne "success") or ($diff_pre_pack_setup_time_report ne "success")) 
		{
