...
def run(
    ...
    if should_run_stage(VtrStage.VPR, start_stage, end_stage):
        ...
        if route_fixed_w:
            ...
            if ("write_rr_graph" in vpr_args or
                "analysis" in vpr_args or
                "route" in vpr_args or
                "write_router_lookahead" in vpr_args or
                "write_intra_cluster_router_lookahead" in vpr_args):
                do_second_run = True
