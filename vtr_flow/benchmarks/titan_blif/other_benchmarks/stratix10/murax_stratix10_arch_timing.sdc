#VPR compatible SDC file for benchmark circuit 'murax_symbiflow'
...
create_clock -period 1.000 {io_mainClk}
...
# Set Clock Latency
#**************************************************************
set_clock_latency -source 0.000 [get_clocks {io_mainClk}]

#**************************************************************
# Set Clock Uncertainty
#**************************************************************
set_clock_uncertainty -from [get_clocks {io_mainClk}] -to [get_clocks {io_mainClk}] 0.000
set_clock_uncertainty -from [get_clocks {io_mainClk}] -to [get_clocks {virtual_io_clock}] 0.000
set_clock_uncertainty -from [get_clocks {virtual_io_clock}] -to [get_clocks {io_mainClk}] 0.000
