...
class ConcreteSetupTimingInfo : public SetupTimingInfo {
    public:
        ...
        ConcreteSetupTimingInfo(std::shared_ptr<const tatum::TimingGraph> timing_graph_v, 
            ...
            , slack_crit_(g_ctx.atom_nl, g_ctx.atom_lookup) {
            //pass
        }
    ...
    public:
        ...
        void update_setup() override {
            ...
            g_ctx.timing_analysis_profile_stats.sta_wallclock_time += sta_wallclock_time;
            g_ctx.timing_analysis_profile_stats.slack_wallclock_time += slack_wallclock_time;
            g_ctx.timing_analysis_profile_stats.num_full_updates += 1;
        }
