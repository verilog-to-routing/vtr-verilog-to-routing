    ...
    public: //Callback interface
        ...
        void inputs(std::vector<std::string> input_names) override {
            ...
            for(const auto& input : input_names) {
                ...
                curr_model().create_pin(port_id, 0, net_id, PinType::DRIVER, PortType::OUTPUT);
            }
        }
        ...
        void outputs(std::vector<std::string> output_names) override { 
            ...
            for(const auto& output : output_names) {
                ...
                curr_model().create_pin(port_id, 0, net_id, PinType::SINK, PortType::INPUT);
            }
        }
        ...
        void names(std::vector<std::string> nets, std::vector<std::vector<blifparse::LogicValue>> so_cover) override { 
            ...
            for(size_t i = 0; i < nets.size() - 1; ++i) {
                ...
                curr_model().create_pin(input_port_id, i, net_id, PinType::SINK, PortType::INPUT);
            }
            ...
            curr_model().create_pin(output_port_id, 0, net_id, PinType::DRIVER, PortType::OUTPUT, output_is_const);
        }
