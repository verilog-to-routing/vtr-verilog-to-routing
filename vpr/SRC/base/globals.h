...
/* use the pin facing info to adjust pin coord */
enum class Pin_side : char {
    TOP = 0x1, RIGHT = 0x2, BOTTOM = 0x4, LEFT = 0x8
};
extern char *g_pin_side;  /*[0..num_rr_nodes-1]*/
extern map<int, int> g_ipin_to_sink; /*g_ipin_to_sink[pin_inode] = sink*/
extern map<int, int> g_opin_by_source;
/********************************************************************
 ...
 ********************************************************************/
/* used by util functions to analyze router quality */
extern bool route_start;
