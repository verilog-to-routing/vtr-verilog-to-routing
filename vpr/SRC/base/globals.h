/* 
 ...
 These variables represent the user netlist in various stages of the CAD flow:
  ...
  g_clbs_nlist and g_blocks for the clustered netlist post packing
 */
...
extern struct s_block *g_blocks;

/* External-to-complex g_blocks, post-packed netlist [NETS ONLY]*/
...
extern int **g_rr_blk_source; /* [0..g_num_blocks-1][0..num_class-1] */
