...
struct TimingContext : public Context {
    ...
    vtr::t_ivec *tnodes_at_level; /* [0..num__tnode_levels - 1].  Count and list of tnodes at each level of    
...
struct PlacementContext : public Context {
    ...
    vtr::Matrix<t_grid_blocks,2> grid_blocks; //[0..device_ctx.nx+1][0..device_ctx.ny+1]
