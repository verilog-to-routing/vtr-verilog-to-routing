...
/* autogenerated in build_rr_graph based on switch fan-in. [0..(g_num_rr_switches-1)] */
int g_num_rr_switches = 0;
s_rr_switch_inf *g_rr_switch_inf = NULL; 

/* an array of map. array index: [0..(g_num_arch_switches-1)]; map key: # of fanin; map value: remapped switch index */
map<int, int> *g_switch_fanin_remap = NULL; 
