...
float ExtendedMapLookahead::get_chan_ipin_delays(RRNodeId to_node) const {
    ...
    auto to_tile_type = device_ctx.grid.get_physical_type(t_physical_tile_loc(rr_graph.node_xlow(to_node), rr_graph.node_ylow(to_node)));
...
void ExtendedMapLookahead::compute(const std::vector<t_segment_inf>& segment_inf, const int /*layer_num*/) {
