...
static void compute_router_wire_compressed_lookahead(const std::vector<t_segment_inf>& segment_inf_vec, int route_verbosity, bool warn_arch_rr_lookahead);
...
CompressedMapLookahead::CompressedMapLookahead(const t_det_routing_arch& det_routing_arch, bool is_flat, int route_verbosity, bool warn_arch_rr_lookahead)
...
void CompressedMapLookahead::compute(const std::vector<t_segment_inf>& segment_inf) {
    ...
    compute_router_wire_compressed_lookahead(segment_inf, route_verbosity_, warn_arch_rr_lookahead_);
