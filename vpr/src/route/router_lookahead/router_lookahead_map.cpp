...
static void compute_router_wire_lookahead(const std::vector<t_segment_inf>& segment_inf, int route_verbosity, bool warn_arch_rr_lookahead);
...
MapLookahead::MapLookahead(const t_det_routing_arch& det_routing_arch, bool is_flat, int route_verbosity, bool warn_arch_rr_lookahead)
...
void MapLookahead::compute(const std::vector<t_segment_inf>& segment_inf) {
    ...
    compute_router_wire_lookahead(segment_inf, route_verbosity_, warn_arch_rr_lookahead_);
