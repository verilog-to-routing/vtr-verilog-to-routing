...
typedef vtr::NdMatrix<util::CostEntry, 6> t_simple_cost_map; //[0..num_layers][0..num_layers][0..1][[0..num_seg_types-1][0..device_ctx.grid.width()-1][0..device_ctx.grid.height()-1]
