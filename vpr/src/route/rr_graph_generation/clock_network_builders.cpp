...
int ClockRib::create_chanx_wire(int layer,
    ...
    rr_graph_builder.set_node_layer_low(chanx_node, layer);
    rr_graph_builder.set_node_layer_high(chanx_node, layer);
...
int ClockSpine::create_chany_wire(int layer,
    ...
    rr_graph_builder.set_node_layer_low(chany_node, layer);
    rr_graph_builder.set_node_layer_high(chany_node, layer);
