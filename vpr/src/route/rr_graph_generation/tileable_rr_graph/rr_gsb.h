...
class RRGSB {
  ...
  public:    /* Accessors */
    ...
    RRNodeId get_mux_node(const size_t& ptc) const;
    ...
    bool is_mux_node(const RRNodeId& node) const;
  ...
  public: /* Mutators */
    ...
    void sort_chan_node_in_edges(const RRGraphView& rr_graph, const bool reorder_incoming_edges);
