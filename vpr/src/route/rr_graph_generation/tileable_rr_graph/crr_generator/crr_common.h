...
class Connection {
  public:
    ...
    bool operator<(const Connection& other) const {
        return std::tie(sink_node_, src_node_, switch_id_) < std::tie(other.sink_node_, other.src_node_, other.switch_id_);
    }

    bool operator==(const Connection& other) const {
        return sink_node_ == other.sink_node_ && src_node_ == other.src_node_ && switch_id_ == other.switch_id_;
    }
