...
class ExtendedMapLookahead : public RouterLookahead {
  ...
  public:
     ...
     */
    std::pair<float, float> get_expected_delay_and_cong_ignore_criticality(RRNodeId inode, RRNodeId target_node, const t_conn_cost_params& params, float R_upstream) const override;
