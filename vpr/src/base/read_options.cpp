...
argparse::ArgumentParser create_arg_parser(const std::string& prog_name, t_options& args) {
    ...
    crr_grp.add_argument<bool, ParseOnOff>(args.preserve_input_pins, "--preserve_input_pins")
        .help("Whether the input pins connections should be generated by the default flow and not from the CRR template")
        .default_value("off")
        .show_in(argparse::ShowIn::HELP_ONLY);
    
    crr_grp.add_argument<bool, ParseOnOff>(args.preserve_output_pins, "--preserve_output_pins")
        .help("Whether the output pins connections should be generated by the default flow and not from the CRR template")
        .default_value("off")
        .show_in(argparse::ShowIn::HELP_ONLY);
