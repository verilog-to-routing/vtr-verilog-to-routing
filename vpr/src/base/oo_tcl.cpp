...
TCL_eCustomException::TCL_eCustomException(std::string&& message_) : message(std::move(message_)) {}
TCL_eCustomException::operator std::string() const { return (this->message); }

TCL_eFailedToInitTcl::TCL_eFailedToInitTcl(int error_code_) : error_code(error_code_) {}
...
OV_TOSTRING(TCL_eErroneousTCL, this->filename + ":" + std::to_string(this->line) + "," +
