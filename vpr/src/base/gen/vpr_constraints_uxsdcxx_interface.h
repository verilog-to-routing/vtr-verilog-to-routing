...
using AddAtomReadContext = void *;
	...
	using AssignmentReadContext = void *;
...
public:
	...
	*/
	 ...
	 * </xs:complexType>
	*/
	virtual inline const char * get_assignment_net(typename ContextTypes::AssignmentReadContext &ctx) = 0;
	virtual inline void set_assignment_net(const char * net, typename ContextTypes::AssignmentWriteContext &ctx) = 0;
	virtual inline const char * get_assignment_pin(typename ContextTypes::AssignmentReadContext &ctx) = 0;
	virtual inline void set_assignment_pin(const char * pin, typename ContextTypes::AssignmentWriteContext &ctx) = 0;
	 ...
	 * </xs:complexType>
	*/
	virtual inline void preallocate_packer_constraints_assignment(typename ContextTypes::PackerConstraintsWriteContext &ctx, size_t size) = 0;
	virtual inline typename ContextTypes::AssignmentWriteContext add_packer_constraints_assignment(typename ContextTypes::PackerConstraintsWriteContext &ctx) = 0;
	virtual inline void finish_packer_constraints_assignment(typename ContextTypes::AssignmentWriteContext &ctx) = 0;
	virtual inline size_t num_packer_constraints_assignment(typename ContextTypes::PackerConstraintsReadContext &ctx) = 0;
	virtual inline typename ContextTypes::AssignmentReadContext get_packer_constraints_assignment(int n, typename ContextTypes::PackerConstraintsReadContext &ctx) = 0;
	 ...
	 *       <xs:element name="packer_constraints" type="packer_constraints" />
	 *     </xs:choice>
	...
	*/
	...
	virtual inline void preallocate_vpr_constraints_packer_constraints(typename ContextTypes::VprConstraintsWriteContext &ctx, size_t size) = 0;
	virtual inline typename ContextTypes::PackerConstraintsWriteContext add_vpr_constraints_packer_constraints(typename ContextTypes::VprConstraintsWriteContext &ctx) = 0;
	virtual inline void finish_vpr_constraints_packer_constraints(typename ContextTypes::PackerConstraintsWriteContext &ctx) = 0;
	virtual inline size_t num_vpr_constraints_packer_constraints(typename ContextTypes::VprConstraintsReadContext &ctx) = 0;
	virtual inline typename ContextTypes::PackerConstraintsReadContext get_vpr_constraints_packer_constraints(int n, typename ContextTypes::VprConstraintsReadContext &ctx) = 0;
};
