...
class AtomNetlist : public Netlist<AtomBlockId, AtomPortId, AtomPinId, AtomNetId> {
  ...
  public: //Public Accessors
    ...
    //  net_name : a net name
    std::unordered_set<std::string> net_aliases(std::string net_name) const;
  ...
  public: //Public Mutators
    ...
    //Adds a value to the net aliases set for a fiven input assigned_net_name in the net_aliases_map.
    ...
    void add_net_alias(std::string assigned_net_name, std::string alias_net_name);
