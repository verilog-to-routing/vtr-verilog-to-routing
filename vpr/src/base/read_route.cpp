...
bool read_route(const char* route_file, const t_router_opts& router_opts, bool verify_file_digests) {
    ...
    std::unordered_set<int> overused_local_nodes; // dummy node set to pass into the function, not used
    reserve_locally_used_opins(&small_heap, router_opts.initial_pres_fac, router_opts.acc_fac, false, overused_local_nodes);
    ...
    reserve_locally_used_opins(&small_heap, router_opts.initial_pres_fac, router_opts.acc_fac, true, overused_local_nodes);
