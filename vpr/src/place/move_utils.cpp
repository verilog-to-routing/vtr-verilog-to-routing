...
const std::array<std::string, NUM_AVAIL_MOVES> move_type_strings = {
    "Uniform",
    "Median",
    "W. Centroid",
    "Centroid",
...
static_assert(move_type_strings.size() == NUM_AVAIL_MOVES, "The available move types and move_Type_strings arenot matched");
