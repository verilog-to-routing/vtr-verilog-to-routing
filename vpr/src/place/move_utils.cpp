...
const std::array<std::string, 7> move_type_strings = {
    "Uniform",
    "Median",
    "W. Centroid",
    "Centroid",
...
static_assert(move_type_strings.size() == static_cast<int>(e_move_type::Count), "The available move types and move_Type_strings arenot matched");
