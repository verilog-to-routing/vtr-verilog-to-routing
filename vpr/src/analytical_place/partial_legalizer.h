 ...
 *
 * This provied functionality that all Partial Legalizer will use.
 *
 ...
 *
 * Bins can be thought of as generalized tiles which have a capacity of block
...
struct LegalizerBin {
    ...
    /// @brief The maximum mass of each primitive this bin can contain.
    PrimitiveVector capacity;

    /// @brief The current mass of each primitive this bin contains.
...
private:
    ...
    /// @brief A list of all the bins in the legalizer.
     ...
     * bins in each of the four cardinal directions with the minimum manhatten
