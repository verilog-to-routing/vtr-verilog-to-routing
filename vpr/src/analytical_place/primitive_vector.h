...
/**
 * @brief A sparse vector class to store an M-dimensional quantity of primtives
 ...
 *
 * This class contains usefull operations to operate and compare different
 * Primitive Vectors.
 */
...
public:
    ...
    /**
     * @brief Computes the manhatten (L1) norm of this vector.
     *
     * This is the sum of the absolute value of all dimensions.
     */
    inline float manhatten_norm() const {
    ...
    /**
     * @brief Clear the vector, which is equivalent to setting it to be the zero
     *        vector.
     */
    inline void clear() {
        data_.clear();
