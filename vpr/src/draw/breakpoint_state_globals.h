...
struct BreakpointState {
    ...
    std::vector<int>
        blocks_affected_by_move; //vector giving the clb netlist block ids of all blocks moving in the current perturbation
...
class BreakpointStateGlobals {
  ...
  public:
    ...
    BreakpointState* get_glob_breakpoint_state() { return &glob_breakpoint_state; }
};
