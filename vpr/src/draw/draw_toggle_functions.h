...
/* Callback function for runtime created toggle_nets button in ui_setup.cpp. Controls whether or not nets are visualized.
...
/* Callback function for runtime created toggle_block_pin_util button in ui_setup.cpp.
...
/* Callback function for runtime created toggle_placement_macros button in ui_setup.cpp.
...
/* Callback function for runtime created toggle_rr button in ui_setup.cpp. Draws different groups of RRs depending on
 * user input. Changes value of draw_state->draw_rr_toggle. */
void toggle_rr_cbk(GtkComboBoxText* self, ezgl::application* app);

/* Callback function for runtime created toggle_congestion button in ui_setup.cpp. Controls if congestion should be visualized.
 * Changes value of draw_state->show_congestion. */
void toggle_cong_cbk(GtkComboBoxText* self, ezgl::application* app);

/* Callback function for runtime created ToggleCongestionCost button in ui_setup.cpp. Controls if congestion cost should be visualized.
 * Changes value of draw_state->show_routing_cost. */
void toggle_cong_cost_cbk(GtkComboBoxText* self, ezgl::application* app);

/* Callback function for runtime created toggle_routing_congestion_cost button in ui_setup.cpp.
...
/* Callback function for runtime created toggle_routing_bounding_box button in ui_setup.cpp.
...
/* Callback function for runtime created toggle_routing_util button in ui_setup.cpp.
...
/* Callback function for runtime created toggle_crit_path button in ui_setup.cpp.
...
/* Callback function for runtime created toggle_router_expansion_costs in ui_setup.cpp.
