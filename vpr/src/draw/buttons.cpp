...
void button_for_toggle_placement_macros() {
    ...
    gtk_combo_box_text_append_text(GTK_COMBO_BOX_TEXT(toggle_placement_macros_widget), "N/A");
    gtk_combo_box_text_append_text(GTK_COMBO_BOX_TEXT(toggle_placement_macros_widget), "Regular");
    gtk_combo_box_set_active((GtkComboBox*)toggle_placement_macros_widget, 0);      // default set to N/A which has an index 0
...
void button_for_toggle_crit_path() {
    ...
    gtk_combo_box_text_append_text(GTK_COMBO_BOX_TEXT(toggle_crit_path_widget), "N/A");
    ...
    gtk_combo_box_set_active((GtkComboBox*)toggle_crit_path_widget, 0);      // default set to N/A which has an index 0
...
void button_for_toggle_rr() {
    ...
    gtk_combo_box_text_append_text(GTK_COMBO_BOX_TEXT(toggle_rr_widget), "N/A");
    gtk_combo_box_text_append_text(GTK_COMBO_BOX_TEXT(toggle_rr_widget), "Mouse over RR");
    ...
    gtk_combo_box_set_active((GtkComboBox*)toggle_rr_widget, 0);      // default set to N/A which has an index 0
...
void button_for_toggle_congestion() {
    ...
    gtk_combo_box_text_append_text(GTK_COMBO_BOX_TEXT(toggle_congestion_widget), "N/A");
    ...
    gtk_combo_box_set_active((GtkComboBox*)toggle_congestion_widget, 0);      // default set to N/A which has an index 0
...
void button_for_toggle_congestion_cost() {
    ...
    gtk_combo_box_text_append_text(GTK_COMBO_BOX_TEXT(toggle_routing_congestion_cost_widget), "N/A");
    ...
    gtk_combo_box_set_active((GtkComboBox*)toggle_routing_congestion_cost_widget, 0);      // default set to N/A which has an index 0
...
void button_for_toggle_routing_bounding_box() {
    ...
    GtkWidget* toggle_routing_bounding_box_widget = gtk_spin_button_new_with_range(0., (route_ctx.route_bb.size() - 1), 1.);
...
void button_for_toggle_routing_util() {
    ...
    gtk_combo_box_text_append_text(GTK_COMBO_BOX_TEXT(toggle_routing_util_widget), "N/A");
    ...
    gtk_combo_box_set_active((GtkComboBox*)toggle_routing_util_widget, 0);      // default set to N/A which has an index 0
...
void button_for_toggle_router_rr_costs() {
    ...
    gtk_combo_box_text_append_text(GTK_COMBO_BOX_TEXT(toggle_router_rr_costs_widget), "N/A");
    ...
    gtk_combo_box_set_active((GtkComboBox*)toggle_router_rr_costs_widget, 0);      // default set to N/A which has an index 0
