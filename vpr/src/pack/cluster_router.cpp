...
static void add_pin_to_rt_terminals(t_lb_router_data* router_data, const AtomPinId pin_id, const AtomPBLookUp &atom_to_pb);
static void remove_pin_from_rt_terminals(t_lb_router_data* router_data, const AtomPinId pin_id, const AtomPBLookUp &atom_to_pb);

static void fix_duplicate_equivalent_pins(t_lb_router_data* router_data, const AtomPBLookUp &atom_to_pb);
