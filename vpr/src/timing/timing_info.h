...
//#define VPR_TATUM_WALKER tatum::ParallelWalker
#define VPR_TATUM_WALKER tatum::SerialIncrWalker

template<class DelayCalc>
std::unique_ptr<SetupTimingInfo> make_setup_timing_info(std::shared_ptr<DelayCalc> delay_calculator) {
    auto& timing_ctx = g_vpr_ctx.timing();

    std::shared_ptr<tatum::SetupTimingAnalyzer> analyzer = tatum::AnalyzerFactory<tatum::SetupAnalysis, VPR_TATUM_WALKER>::make(*timing_ctx.graph, *timing_ctx.constraints, *delay_calculator);
...
std::unique_ptr<HoldTimingInfo> make_hold_timing_info(std::shared_ptr<DelayCalc> delay_calculator) {
    ...
    std::shared_ptr<tatum::HoldTimingAnalyzer> analyzer = tatum::AnalyzerFactory<tatum::HoldAnalysis, VPR_TATUM_WALKER>::make(*timing_ctx.graph, *timing_ctx.constraints, *delay_calculator);
...
std::unique_ptr<SetupHoldTimingInfo> make_setup_hold_timing_info(std::shared_ptr<DelayCalc> delay_calculator) {
    ...
    std::shared_ptr<tatum::SetupHoldTimingAnalyzer> analyzer = tatum::AnalyzerFactory<tatum::SetupHoldAnalysis, VPR_TATUM_WALKER>::make(*timing_ctx.graph, *timing_ctx.constraints, *delay_calculator);
