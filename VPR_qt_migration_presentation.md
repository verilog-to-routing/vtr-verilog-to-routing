...
- Mental model: *"QRhi gives us one renderer that works on every desktop OS, but it only matured into a public API in Qt 6.7, and the first version where it renders our scene correctly is 6.9.3."*
