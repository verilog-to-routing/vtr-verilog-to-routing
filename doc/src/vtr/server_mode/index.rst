...
`https://github.com/w0lek/IPAClient <The interactive path analysis (IPA) client>`_ is useful for viewing timing paths, and to test VPR's server mode functionality.
