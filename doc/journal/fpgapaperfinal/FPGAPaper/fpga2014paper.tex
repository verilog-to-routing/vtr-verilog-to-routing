...
\begin{multline}
\label{eq:tdelay}
T^\prime_{del} = T_{del} + T_{interpose} \times ExpectInterposeHops
\end{multline}
\setlength{\arraycolsep}{5pt}
...
\begin{figure}[!htbp]
\centering
\subfigure[]{\includegraphics[height = 2.3cm]{square_fpga.pdf}}
\subfigure[]{\includegraphics[height = 3.6cm]{tall_fpga.pdf}}
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{vbetz}}]{Vaughn Betz}(S'88--M'91) received the B.Sc(EE) from the University of Manitoba in 1991, the MS(ECE) from the University of Illinois at Urbana-Champaign in 1993, and the PhD(ECE) from the University of Toronto in 1998.
