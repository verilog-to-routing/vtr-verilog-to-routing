...
\begin{figure}[!htbp]
\centering
\includegraphics[width=\linewidth]{minChW_2.eps}
...
Systems with more dice are slower; on average the critical path delay is 40\% higher for a four-die system than a two-die system. This speed difference is not significantly affected by the \textit{\% wires cut}.
\begin{figure}[!htbp]
\centering
