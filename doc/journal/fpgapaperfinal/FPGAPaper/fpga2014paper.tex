...
\begin{figure}[!t]
\subfigure[]{\includegraphics[width=0.17\linewidth]{a.eps}}
\subfigure[]{\includegraphics[width=0.17\linewidth]{b.eps}}
\subfigure[]{\includegraphics[width=0.17\linewidth]{a_prime.eps}}
\subfigure[]{\includegraphics[width=0.17\linewidth]{b_prime.eps}}
...
\begin{figure*}[!thpb]
\centering
\subfigure[]{\includegraphics[width=0.5\textwidth]{gui_1.eps}}
...
Cost_{Total}(r) = \sum_{\forall l \in RT(i,r)} Cost(l) + \alpha \times ExpectCost(r,j)
\end{multline}
\setlength{\arraycolsep}{5pt}
...
ExpectCost(r,j) = Criticality_{fac} \times T_{delay} + \\(1 - Criticality_{fac}) \times ExpectCongestionCost(r,j)
\end{multline}
\setlength{\arraycolsep}{5pt}
...
\begin{multline}
\label{eq:tdelay}
T^\prime_{delay} = T_{delay} + T_{interposer} \times ExpectInterposerHops
\end{multline}
\setlength{\arraycolsep}{5pt}
