...
\centering
\input{wires_cut}
\caption{Impact of partitioning-based CAD flow on routability for a range of architectures. The best flow from~\cite{interposer2014} does not succeed at 90\% wires cut.}
\label{fig:wires_cut}
\end{figure}
