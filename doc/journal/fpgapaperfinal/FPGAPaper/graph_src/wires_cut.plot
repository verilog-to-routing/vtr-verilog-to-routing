...
plot 'wires_cut.dat' using 1:2 with linespoints title '\footnotesize{Best CAD Flow}' linestyle 1, 'wires_cut.dat' using 1:4 with linespoints title '\footnotesize{Best CAD Flow in oldpaper}' linestyle 2
