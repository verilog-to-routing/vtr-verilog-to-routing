...
set output "crit_path_4part.eps"
set xlabel '\footnotesize{\textbf{\% wires cut}}' offset character 0,-2
set ylabel '\footnotesize{\textbf{Critical Path Delay}}' offset character -5,0
plot 'crit_path_4part.dat' using 1:3 with linespoints title '\footnotesize{2 Partitions}' linestyle 1, 'crit_path_4part.dat' using 1:2 with linespoints title '\footnotesize{4 Partitions}' linestyle 2
