...
# defaults
_YOSYS_EXEC="${VTR_DIR}/Yosys/bin/yosys"
...
function help() {
    ...
    OPTIONS
            ...
            -s|--systemverilog < test name >    A path to a single SystemVerilog file
            -u|--uhdm < test name >             A path to a single UHDM file
...
# validate the input file type by checking
# its extension with the expected type
