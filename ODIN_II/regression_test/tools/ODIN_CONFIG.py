...
class config(GeneratedsSuper):
    ...
    def set_verilog_files(self, verilog_files):
        self.verilog_files = verilog_files
    ...
    def set_debug_outputs(self, debug_outputs):
        self.debug_outputs = debug_outputs
    ...
    def hasContent_(self):
        if (
            self.verilog_files is not None
            or self.output is not None
            or self.optimizations is not None
            or self.debug_outputs is not None
        ):
            return True
        else:
            return False
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "verilog_files":
        ...
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "optimizations":
            obj_ = optimizations.factory()
            obj_.build(child_)
            self.set_optimizations(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "debug_outputs":
...
class verilog_files(GeneratedsSuper):
    ...
    def get_verilog_file(self):
        return self.verilog_file

    def set_verilog_file(self, verilog_file):
        self.verilog_file = verilog_file

    def add_verilog_file(self, value):
        self.verilog_file.append(value)

    def insert_verilog_file(self, index, value):
        self.verilog_file[index] = value
    ...
    def exportChildren(self, outfile, level, namespace_="", name_="verilog_files"):
        for verilog_file_ in self.verilog_file:
            showIndent(outfile, level)
            outfile.write(
                "<%sverilog_file>%s</%sverilog_file>\n"
                % (
                    namespace_,
                    self.format_string(
                        quote_xml(verilog_file_).encode(ExternalEncoding), input_name="verilog_file"
                    ),
                    namespace_,
                )
            )
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "verilog_file":
            verilog_file_ = ""
...
class output(GeneratedsSuper):
    ...
    def get_output_path_and_name(self):
        return self.output_path_and_name

    def set_output_path_and_name(self, output_path_and_name):
        self.output_path_and_name = output_path_and_name
    ...
    def exportChildren(self, outfile, level, namespace_="", name_="output"):
        if self.output_type is not None:
            showIndent(outfile, level)
            outfile.write(
                "<%soutput_type>%s</%soutput_type>\n"
                % (
                    namespace_,
                    self.format_string(
                        quote_xml(self.output_type).encode(ExternalEncoding),
                        input_name="output_type",
                    ),
                    namespace_,
                )
            )
        if self.output_path_and_name is not None:
            showIndent(outfile, level)
            outfile.write(
                "<%soutput_path_and_name>%s</%soutput_path_and_name>\n"
                % (
                    namespace_,
                    self.format_string(
                        quote_xml(self.output_path_and_name).encode(ExternalEncoding),
                        input_name="output_path_and_name",
                    ),
                    namespace_,
                )
            )
    ...
    def hasContent_(self):
        if (
            ...
            or self.output_path_and_name is not None
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "output_type":
            output_type_ = ""
            for text__content_ in child_.childNodes:
                output_type_ += text__content_.nodeValue
            self.output_type = output_type_
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "output_path_and_name":
            output_path_and_name_ = ""
            for text__content_ in child_.childNodes:
                output_path_and_name_ += text__content_.nodeValue
            self.output_path_and_name = output_path_and_name_
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "target":
            obj_ = target.factory()
            obj_.build(child_)
...
class target(GeneratedsSuper):
    ...
    def get_arch_file(self):
        return self.arch_file

    def set_arch_file(self, arch_file):
        self.arch_file = arch_file
    ...
    def exportChildren(self, outfile, level, namespace_="", name_="target"):
        if self.arch_file is not None:
            showIndent(outfile, level)
            outfile.write(
                "<%sarch_file>%s</%sarch_file>\n"
                % (
                    namespace_,
                    self.format_string(
                        quote_xml(self.arch_file).encode(ExternalEncoding), input_name="arch_file"
                    ),
                    namespace_,
                )
            )
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "arch_file":
            arch_file_ = ""
            for text__content_ in child_.childNodes:
...
class optimizations(GeneratedsSuper):
    ...
    def hasContent_(self):
        if self.multiply is not None or self.memory is not None:
            return True
        else:
            return False
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "multiply":
            obj_ = multiply.factory()
            obj_.build(child_)
            self.set_multiply(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "memory":
            obj_ = memory.factory()
            obj_.build(child_)
...
class multiply(GeneratedsSuper):
    ...
    def exportAttributes(self, outfile, level, namespace_="", name_="multiply"):
        ...
        if self.fracture is not None:
            outfile.write(
                ' fracture="%s"' % self.format_integer(self.fracture, input_name="fracture")
            )
...
class memory(GeneratedsSuper):
    ...
    def get_split_memory_width(self):
        return self.split_memory_width

    def set_split_memory_width(self, split_memory_width):
        self.split_memory_width = split_memory_width

    def get_split_memory_depth(self):
        return self.split_memory_depth

    def set_split_memory_depth(self, split_memory_depth):
        self.split_memory_depth = split_memory_depth
    ...
    def exportAttributes(self, outfile, level, namespace_="", name_="memory"):
        if self.split_memory_width is not None:
            outfile.write(
                ' split_memory_width="%s"'
                % self.format_integer(self.split_memory_width, input_name="split_memory_width")
            )
        if self.split_memory_depth is not None:
            outfile.write(
                ' split_memory_depth="%s"'
                % self.format_integer(self.split_memory_depth, input_name="split_memory_depth")
            )
...
class debug_outputs(GeneratedsSuper):
    ...
    def get_debug_output_path(self):
        return self.debug_output_path

    def set_debug_output_path(self, debug_output_path):
        self.debug_output_path = debug_output_path

    def get_output_ast_graphs(self):
        return self.output_ast_graphs

    def set_output_ast_graphs(self, output_ast_graphs):
        self.output_ast_graphs = output_ast_graphs
    ...
    def get_output_netlist_graphs(self):
        return self.output_netlist_graphs

    def set_output_netlist_graphs(self, output_netlist_graphs):
        self.output_netlist_graphs = output_netlist_graphs
    ...
    def exportChildren(self, outfile, level, namespace_="", name_="debug_outputs"):
        if self.debug_output_path is not None:
            showIndent(outfile, level)
            outfile.write(
                "<%sdebug_output_path>%s</%sdebug_output_path>\n"
                % (
                    namespace_,
                    self.format_string(
                        quote_xml(self.debug_output_path).encode(ExternalEncoding),
                        input_name="debug_output_path",
                    ),
                    namespace_,
                )
            )
        if self.output_ast_graphs is not None:
            showIndent(outfile, level)
            outfile.write(
                "<%soutput_ast_graphs>%s</%soutput_ast_graphs>\n"
                % (
                    namespace_,
                    self.format_string(
                        quote_xml(self.output_ast_graphs).encode(ExternalEncoding),
                        input_name="output_ast_graphs",
                    ),
                    namespace_,
                )
            )
        if self.output_netlist_graphs is not None:
            showIndent(outfile, level)
            outfile.write(
                "<%soutput_netlist_graphs>%s</%soutput_netlist_graphs>\n"
                % (
                    namespace_,
                    self.format_string(
                        quote_xml(self.output_netlist_graphs).encode(ExternalEncoding),
                        input_name="output_netlist_graphs",
                    ),
                    namespace_,
                )
            )
    ...
    def hasContent_(self):
        if (
            self.debug_output_path is not None
            or self.output_ast_graphs is not None
            or self.output_netlist_graphs is not None
        ):
            return True
        else:
            return False
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "debug_output_path":
            debug_output_path_ = ""
            for text__content_ in child_.childNodes:
                debug_output_path_ += text__content_.nodeValue
            self.debug_output_path = debug_output_path_
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "output_ast_graphs":
            output_ast_graphs_ = ""
            for text__content_ in child_.childNodes:
                output_ast_graphs_ += text__content_.nodeValue
            self.output_ast_graphs = output_ast_graphs_
            self.validate_output_ast_graphs(
                self.output_ast_graphs
            )  # validate type output_ast_graphs
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "output_netlist_graphs":
            output_netlist_graphs_ = ""
            for text__content_ in child_.childNodes:
                output_netlist_graphs_ += text__content_.nodeValue
            self.output_netlist_graphs = output_netlist_graphs_
            self.validate_output_netlist_graphs(
                self.output_netlist_graphs
            )  # validate type output_netlist_graphs
...
def parse(inFileName):
    ...
    rootObj.export(sys.stdout, 0, name_="config", namespacedef_="")
    return rootObj
