...
filemap file_type_strmap({{"ilang", file_type_e::_ILANG},
                         ...
                         static_cast<int>(file_type_e::file_type_e_END));

#define NUM_ODIN_SUBCKT_BLIF_TYPES 4
/**
...
typemap odin_subckt_strmap({{"multiply", MULTIPLY},
                            ...
                            {"adder", ADD},
                            {"sub", MINUS}},
                           NUM_ODIN_SUBCKT_BLIF_TYPES);

#define NUM_YOSYS_SUBCKT_BLIF_TYPES 218
/**
