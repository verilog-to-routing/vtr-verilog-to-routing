...
void ParallelLevelizedBarrierTimingAnalyzer::calculate_timing(TimingGraph& timing_graph) {
#pragma omp parallel
    {
...
void ParallelLevelizedBarrierTimingAnalyzer::pre_traversal(TimingGraph& timing_graph) {
    /*
...
void ParallelLevelizedBarrierTimingAnalyzer::forward_traversal(TimingGraph& timing_graph) {
...
void ParallelLevelizedBarrierTimingAnalyzer::backward_traversal(TimingGraph& timing_graph) {
...
void ParallelLevelizedBarrierTimingAnalyzer::pre_traverse_node(TimingGraph& tg, NodeId node_id, int level_idx) {
...
void ParallelLevelizedBarrierTimingAnalyzer::forward_traverse_node(TimingGraph& tg, NodeId node_id) {
...
void ParallelLevelizedBarrierTimingAnalyzer::backward_traverse_node(TimingGraph& tg, NodeId node_id) {
