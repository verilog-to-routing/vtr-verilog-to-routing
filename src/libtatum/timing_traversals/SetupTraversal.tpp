...
void SetupTraversal<Base>::forward_traverse_edge(MemoryPool& tag_pool, const TimingGraph& tg, const DelayCalcType& dc, const NodeId node_id, const EdgeId edge_id) {
