 ...
 * [This particular pattern is the Curriosly Recurring Template Pattern, or CRTP].
 * This gives us static (i.e. resolved at compile time) polymorphism, allowing
 * the compiler to fully inline (and optimize) the operations defined in the
 * mixin class. This yeilds a noticable (~17%) run-time improvement, compared
 * to no inlining.
 */
