...
#   * a Qt6 SDK >= the supported floor  (dev/install_qt6_sdk.sh)
#
# dev/install_qt6_sdk.sh is system-first: if the apt-installed Qt6 already
...
"${SCRIPT_DIR}/dev/install_qt6_sdk.sh"
