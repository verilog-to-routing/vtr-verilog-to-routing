...
void TimingConstraints::set_input_constraint(const NodeId node_id, const float constraint) {
...
void TimingConstraints::set_output_constraint(const NodeId node_id, const float constraint) {
