...
class HoldTimingAnalyzer : public virtual TimingAnalyzer {
    public:
        ...
        TimingTags::tag_range hold_slacks(EdgeId edge_id) const { return hold_slacks_impl(edge_id); }
    ...
    protected:
        ...
        virtual TimingTags::tag_range hold_slacks_impl(EdgeId edge_id) const = 0;
};
