...
string generate_opname (t_node* vqm_node);	//generates a mode-hashed name for a subcircuit instance
...
bool is_lut (t_node* vqm_node);	//returns TRUE if a given VQM Node is identified as a LUT.
