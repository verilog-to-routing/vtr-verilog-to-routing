...
TEST_CASE("fasm_integration_test", "[fasm]") {
    ...
    vpr_setup.PackerOpts.doPacking             = e_stage_action::STAGE_LOAD;
    vpr_setup.PlacerOpts.doPlacement           = e_stage_action::STAGE_LOAD;
    vpr_setup.APOpts.doAP                      = e_stage_action::STAGE_SKIP;
    vpr_setup.RouterOpts.doRouting             = e_stage_action::STAGE_LOAD;
    vpr_setup.RouterOpts.read_rr_edge_metadata = true;
    vpr_setup.AnalysisOpts.doAnalysis          = e_stage_action::STAGE_SKIP;
