...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        nargs="*",
        help="A VPR placement log(s)")

    parser.add_argument(
        "--xdata",
        type=str,
        default="t",
        help="Horizontal axis data source")

    parser.add_argument(
        "--ydata",
        type=str,
        default="av_cost",
        help="Vertical axis data source")
    ...
    parser.add_argument(
        "--list-columns",
        action="store_true",
        help="List available column names to plot")

    parser.add_argument(
        "-o",
        type=str,
        default=None,
        help="Output file name to save the plot to or none to show it")
    ...
    for log_file in args.log:
        ...
        if args.xdata == args.ydata:
            print("Plotting '{}' vs '{}' makes no sense".format(
                args.ydata, args.xdata))
            exit(-1)
